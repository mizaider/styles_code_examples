...
function my_theme_enqueue_scripts_and_styles() {
    wp_enqueue_style( 'main', get_stylesheet_directory_uri() . '/css/style.min.css', array(), null, 'all' );
    wp_enqueue_style( 'magnific-popup', get_stylesheet_directory_uri() . '/css/magnific-popup.css', array('main'), null, 'all' );
...
add_image_size( 'cat-item-thumb', 200, 300, true );
